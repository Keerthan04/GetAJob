...
const EmployerProtectedWrapper = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/employer/profile`, {
        headers: {
  ...
  }, [navigate, setEmployerData, token]);
...
export default EmployerProtectedWrapper;
